...
from transformers import (WEIGHTS_NAME, BertConfig,
                          ...
                          XLNetTokenizer,
                          AlbertForSequenceClassification, AutoConfig, AutoModel, AutoTokenizer)
...
def main():
    ...
    ## Required parameters
    parser.add_argument("--data_dir", default="datasets/cmnli/", type=str,
                        help="The input data dir. Should contain the .tsv files (or other data files) for the task.")
    parser.add_argument("--model_type", default="albert", type=str,
                        help="Model type selected in the list: " + ", ".join(MODEL_CLASSES.keys()))
    parser.add_argument("--model_name_or_path", default="voidful/albert_chinese_base", type=str,
                        help="Path to pre-trained model or shortcut name selected in the list")
    parser.add_argument("--task_name", default="cmnli", type=str,
                        help="The name of the task to train selected in the list: " + ", ".join(processors.keys()))
    parser.add_argument("--output_dir", default="outputs/cmnli_output/", type=str,
